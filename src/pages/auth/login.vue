...
import AuthEntryPage from '@/components/auth/AuthEntryPage.vue'

// 路由 query 会作为 attrs 传入，不能覆盖根组件已校验的 redirect。
...
<template>
  <AuthEntryPage initial-mode="login" :redirect="redirect" />
</template>
