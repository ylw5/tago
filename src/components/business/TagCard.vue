...
.tag-card__identity,.tag-card__body,.tag-card__cta { position:relative; z-index:2; }
.tag-card__identity { display:flex; width:88rpx; flex-direction:column; align-items:center; gap:4rpx; }
.tag-card__name,.tag-card__title,.tag-card__summary { display:block; overflow:hidden; text-overflow:ellipsis; white-space:nowrap; }
.tag-card__name { max-width:100%; color:var(--tago-ink); font-size:20rpx; font-weight:700; line-height:1.2; }
...
@media (max-width:480px) {
  .tag-card { column-gap:8px; min-height:56px; margin-bottom:3px; padding:6px 10px 6px 16px; }
  .tag-card :deep(.avatar--md) { width:36px; height:36px; }
  .tag-card__identity { width:44px; gap:2px; }
  .tag-card__name { font-size:10px; }
  .tag-card__title { font-size:15px; font-weight:800; letter-spacing:0; }
  .tag-card__summary { margin-top:4px; font-size:11px; }
  .tag-card__cta { width:78px; height:30px; border-width:1px; font-size:13px; line-height:28px; }
}

@media (max-width:360px) {
  .tag-card { column-gap:6px; }
