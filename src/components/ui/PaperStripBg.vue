...
<template>
  <svg class="paper-strip" viewBox="0 0 900 156" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
    <defs>
      <filter id="strip-rough" x="-3%" y="-12%" width="106%" height="124%">
      ...
      <linearGradient :id="`strip-grad-${tone}`" x1="0" y1="0" x2="1" y2=".8">
...
.paper-strip { position: absolute; inset: 0; width: 100%; height: 100%; pointer-events: none; color: var(--tago-ink); }
</style>
